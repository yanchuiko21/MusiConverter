...
buttonSubmit = Button(window, text="Sumbit", font=("Comic Sans MS", 19), bg="#FFFFFF", fg="#000000", width=10, height=1, command=convert_playlist)
buttonSubmit.place(relx=0.5, rely=0.77, anchor=CENTER)

buttonExit = Button(window, text="Exit", font=("Comic Sans MS", 19), bg="#FFFFFF", fg="#000000", width=10, height=1, command=window.destroy)
buttonExit.place(relx=0.5, rely=0.89, anchor=CENTER)
